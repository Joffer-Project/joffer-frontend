...
const SignUpFormStep2 = ({ className, ...props }: UserAuthFormProps) => {
    ...
    return (
        <div className={cn("grid gap-6 p-20", className)} {...props}>
            ...
            <p className="font-medium text-xl mb-4">Select the industries that align best with your interests, knowledge, experience, and wishes. </p>
            <Form {...form}>
   ...
   py-3 px-6 font-bold text-[#FF7E33] transition-colors duration-200 ease-in-out peer-checked:bg-gray-200 peer-checked:text-gray-900 peer-checked:border-gray-200 "> {industry} </label>
                    ...
                    <div className="flex justify-between items-center pt-8">
                        ...
                        <Button disabled={isLoading} type="button" onClick={() => router.push(`/talent/signup`)} className="bg-[#FF7E33] w-[180px] h-[60px] border rounded-[40px] text-xl">
                            {isLoading && (
                                <p>Loading...</p>
                            )}
                            Previous
