		...
		<>
			...
			<div className={cn("grid gap-6 p-20", className)} {...props}>
				...
				<p className="font-regular text-xl mb-4 text-[#5C6062]">
					Share some information about your career path. Remember to
					keep it direct, these pieces of information can place you
					ahead.
				</p>
				<Form {...form}>
					<form className="space-y-2">
						...
						<FormItem>
							<FormControl>
								<Input
									...
									className="h-[260px] rounded-20px] border border-[#FF7E33] text-regular text-center p-4 bg-[#F4F4F4]"
								/>
							</FormControl>
							<FormMessage>
						...
						<div className="flex justify-between items-center pt-8">
							...
							<Button
								...
								className="bg-[#5C6062] w-[180px] h-[60px] border rounded-[40px] text-xl">
								{isLoading && <p>Loading...</p>}
								Preview
							</Button>
							<Button
