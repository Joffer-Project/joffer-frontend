            ...
            <Form {...form}>
                <form className="space-y-2">
                    ...
                    <div className="flex justify-between items-center pt-8">
                        ...
                        <Button disabled={isLoading} type="button" onClick={() => router.push(`/talent/signup/preview`)} className="bg-[#5C6062] w-[180px] h-[60px] border rounded-[40px] text-xl">
                            {isLoading && (
                                <p>Loading...</p>
                            )}
                            Preview
                        </Button>
                        <Button disabled={isLoading} className="bg-[#FF7E33] w-[180px] h-[60px] border rounded-[40px] text-xl">
                            {isLoading && (
                                <p>Loading...</p>
                            )}
                            Start
