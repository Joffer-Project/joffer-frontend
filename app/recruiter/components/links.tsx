...
import { AlignHorizontalJustifyStart, Dribbble, GithubIcon, Linkedin, UserRound } from "lucide-react";
        ...
        <div className="flex gap-2 justify-center items-center w-full overflow-hidden scroll-hidden md:h-1/5 sm:h-1/6 xxs:h-[65px] xls:h-[50px]">
           ...
           h-full ">
                ...
                className="flex flex-col items-center justify-center gap-2 ">
                    ...
                    <GithubIcon size={32} className={cn(data && data.gitHubUrl? "text-[#8FE278]" : "text-[#909390]" )} />
           ...
           h-full ">
                <a href={data ? data.personalUrl : "#"} target="_blank" rel="noreferrer">
                    <Linkedin size={32} className={cn(data && data.personalUrl? "text-[#8FE278]" : "text-[#909390]" )} />
                    <span className="font-semibold text-[13px] text-[#5C6062]
                    xl:visible
                    ml:visible
                    md:visible
           ...
           h-full ">
                <a href={data ? data.linkedInUrl : "#"} target="_blank" rel="noreferrer">
                    <AlignHorizontalJustifyStart size={32} className={cn(data && data.linkedInUrl? "text-[#8FE278]" : "text-[#909390]" )} />
                    <span className="font-semibold text-[13px] text-[#5C6062]
                    xl:visible
                    ml:visible
                    md:visible
           ...
           h-full ">
                <a href={data ? data.mediumUrl : "#"} target="_blank" rel="noreferrer">
                    <Dribbble size={32} className={cn(data && data.mediumUrl? "text-[#8FE278]" : "text-[#909390]" )} />
                    <span className="font-semibold text-[13px] text-[#5C6062]
                    xl:visible
                    ml:visible
                    md:visible
           ...
           h-full ">
                <a href={data ? data.dribbleUrl : "#"} target="_blank" rel="noreferrer">
                    <UserRound size={32} className={cn(data && data.dribbleUrl? "text-[#8FE278]" : "text-[#909390]" )} />
                    <span className="font-semibold text-[13px] text-[#5C6062]
                    xl:visible
                    ml:visible
                    md:visible
