...
const Industries: React.FC<IndustriesProps> = ({
    ...
    return (
        <>
            ...
            2xl:mb-[18px]
            2xl:ml-[20px]
            ">Choose the industries that align best with where your company holds a place. </p>
            <Form {...form}>
                                            ...
                                            render={({ field }) => {
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <FormLabel className={`border-2 rounded-[40px] bg-[#fff] !mt-0 px-[30px] py-[14px] border-[#5496EE] hover:border-[#58D336] hover:text-[#58D336] cursor-pointer font-medium text-[18px] ${field.value?.includes(item.id.toString()) ? "text-[#ffffff] bg-gradient-to-br from-[#58D336] to-[#3E9626] border-[#ffffff] hover:text-[#ffffff]" : "text-[#5496EE]"}`}>
                                                            {item.name}
                                                        </FormLabel>
                                                    </FormItem>
                                                )
