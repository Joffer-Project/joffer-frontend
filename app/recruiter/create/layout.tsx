...
interface RecruiterCreateLayoutProps {
  children: React.ReactNode;
}
const RecruiterCreateLayout: React.FC<RecruiterCreateLayoutProps> = ({
  children
}) => {
  ...
  return (
    <>
      ...
      2xl:flex-row">
        ...
        <div className="flex flex-col justify-center items-center bg-gradient-to-br from-[#5496EE] to-[#0063E6] shadow-xl shadow-[#0c0a1b2a] rounded-l-lg px-14
        xls:invisible
        xls:h-[0px]
        xls:w-[0px]
        lg:visible
...
export default RecruiterCreateLayout;