...
import "../../../src/App.css";
import recruiterBg from "../../../src/images/landing-page/recruiter-bg.webp";
import talentBg from "../../../src/images/landing-page/talent-bg.webp";
import logoSlogan from "../../../src/images/logo-slogan.svg";
...
function MyComponent() {
  return (
    <main className="main-container">
      <img className="logo" src={logoSlogan} alt="Logo" />
      <h1 className="slogan">Your professional matchmaker!</h1>
